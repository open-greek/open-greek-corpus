...
# Canonical sigma normalization is shared across all exporters (a per-exporter
# copy once medialized a word-final sigma inside a multi-word lemma string; see
